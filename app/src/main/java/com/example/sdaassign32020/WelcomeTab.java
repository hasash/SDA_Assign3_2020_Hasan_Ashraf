 ...
 * Use the {@link WelcomeTab#newInstance} factory method to
...
public class WelcomeTab extends Fragment {
    ...
    public static WelcomeTab newInstance(String param1, String param2) {
        WelcomeTab fragment = new WelcomeTab();
